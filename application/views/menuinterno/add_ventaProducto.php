...
?>
<!-- <div class="modal-overlay" id="addVentaProducto">
    <div class="modal">
     ...
     <div class="modal fade" id="addVentaProducto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="text" class="form-control text-right" id="totalVenta" name="totalVenta" value ="">
...
<script>
  $(document).ready(function(){
    const txtCantidad = (document.getElementById("cantidadVenta"))  ?  document.getElementById("cantidadVenta").value :0;
